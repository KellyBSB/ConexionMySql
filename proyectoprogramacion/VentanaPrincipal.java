...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
      ...
      String usuProfesor="1234567890";
      String passProfesor="profesor";
      String usuEstudiante="9876543210";
      String passEstudiante="estudiante";
      String pass = new String(passIngreso.getPassword());
      String ingreso=cboxModo.getSelectedItem().toString();
      if(ingreso.equals("Profesor") && txtCedula.getText().equals(usuProfesor) && pass.equals(passProfesor)){
      ...
      }else if(ingreso.equals("Estudiante") && txtCedula.getText().equals(usuEstudiante) && pass.equals(passEstudiante)){
        ...
        if(cn==null){
          ...
          JOptionPane.showMessageDialog(this, "La contraseña o cédula estan mal ingresados");
      }
