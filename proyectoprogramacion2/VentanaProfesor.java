...
public class VentanaProfesor extends javax.swing.JFrame {
   ...
   void limpiar(){
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Buscar por curso ");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String apellido=tbDatosProfesor.getValueAt(filaSelecionada, 3).toString();
        if(filaSelecionada>=0){
            try{
            PreparedStatement pst=cn.prepareStatement("DELETE FROM materias WHERE ApellidoEst='"+apellido+"'");
            pst.executeUpdate();
